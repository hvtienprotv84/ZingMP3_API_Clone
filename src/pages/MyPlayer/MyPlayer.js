...
function MyPlayer() {
    ...
    return (
        <div className={cx('wrapper')}>
            ...
            <div className={cx('container_copyright_mine')}>
                <h1 className={cx('copyright_mine')}>&copy;	Mọi Bản Quyền Thuộc Về <a href='https://github.com/hvtienprotv84'><span className={cx('copyright_mine_myname')}>Huỳnh Vĩnh Tiến</span></a></h1>
            </div>
        </div>
    );
}
