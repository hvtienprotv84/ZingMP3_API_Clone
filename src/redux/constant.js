...
export const MENU_THEME_LIST = {
    artist: [
        ...
        {
            title: 'Sơn Tùng M-TP',
            cardArtist: require('../assets/images/LisTheme/background_mtp.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_mtp.jpg'),
                colorPrimary: '#D08011',
                textHover: '#F59D22',
                playerBg: '#4C473E',
        ...
        {
            title: 'BTS',
            cardArtist: require('../assets/images/LisTheme/background_bts.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_bts.jpg'),
                colorPrimary: '#1A3570',
                textHover: '#4C7CFF',
                layoutBg: 'tranparent',
        ...
        {
            title: 'BlackPink',
            cardArtist: require('../assets/images/LisTheme/background_blackpink.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_blackpink.jpg'),
                colorPrimary: '#BBB9C4',
                textHover: '#6F1F89',
                layoutBg: 'tranparent',
        ...
        },
        {
            ...
            cardArtist: require('../assets/images/LisTheme/background_noo.webp'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_noo.webp'),
                colorPrimary: '#8D22C3',
                textHover: '#8D22C3',
                layoutBg: 'tranparent',
        ...
        {
            title: 'Alan Walker',
            cardArtist: require('../assets/images/LisTheme/background_aw.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_aw.jpg'),
                colorPrimary: '#1A3570',
                textHover: '#4C7CFF',
                layoutBg: 'tranparent',
        ...
        },
        {
            ...
            cardArtist: require('../assets/images/LisTheme/background_rose.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_rose.jpg'),
                colorPrimary: '#EFEDEB',
                textHover: '#AC3E82', 
                layoutBg: 'tranparent',
                layoutHeaderBg: 'rgb(241, 221, 216, 0.8)',
        ...
        {
            title: 'Hồ Quang Hiếu',
            cardArtist: require('../assets/images/LisTheme/background_hqh2.jpg'),
            properties: {
                backgroundImg: require('../assets/images/LisTheme/background_hqh2.jpg'),
                colorPrimary: '##D14781',
                textHover: '#CC3373',
                layoutBg: 'tranparent',
                layoutHeaderBg: 'rgb(241, 221, 216, 0.8)',
